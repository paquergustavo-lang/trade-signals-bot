  ...
  return (
    <div style={styles.page}>
      ...
      <section style={styles.section}>
        <h2 style={styles.sectionTitle}>Sinais recentes ({signals.length})</h2>
        {signals.length === 0 ? (
          <p style={styles.empty}>
            Nenhum sinal recebido ainda. Configure um alerta no TradingView apontando pro
            endpoint /api/webhook — veja o README do projeto.
          </p>
        ) : (
